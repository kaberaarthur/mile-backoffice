    ...
    <>
      ...
      <div className="flex flex-col items-center px-5 pt-16 pb-24 intro-y box mt-7">
        ...
        <div className="text-center">
          <div className="mt-5 text-4xl font-bold">Reported Issue.</div>
          <div className="mt-3 text-base text-primary">{reportData?.issue}</div>
          <a href="" className="block text-base mt-3 text-slate-500">
            Chat with the driver below.
          </a>
        </div>
        {/* END: Invoice Title */}
